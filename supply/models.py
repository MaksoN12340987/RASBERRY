...
class SupplySwitch(models.Model):
    ...
    adres_registr = models.IntegerField(help_text="Цена", verbose_name="Адресс регистра")
    image = models.ImageField(upload_to="supply/media/photo", verbose_name="Фотография", null=True)
